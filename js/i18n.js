...
(function () {
  ...
  var DICT = {
    ...
    "Setlogの招待ID（複数可）": "Setlog invite IDs (multiple)",
    "グループの招待IDをここに入力してね！": "Enter your group's invite ID here!",
    ...
    "プロフィール画像（1枚）": "Profile image (1)",
    "プロフィール画像（1枚・必須）": "Profile image (1, required)",
    "プロフィール画像を選んでください。": "Please choose a profile image.",
    "画像を選ぶ": "Choose image", "画像を変更": "Change image",
    ...
    // 広告のトラッキング設定（iOS の ATT）の訳語は削除した（2026-08-04）。
    // iOS ではトラッキングを行わないため、該当する画面が無い。
